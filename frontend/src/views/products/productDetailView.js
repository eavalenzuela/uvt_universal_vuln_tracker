...
export async function ProductDetailView(params = {}) {
  ...
  const header = el(
    "div",
    { class: "card" },
    el("div", { class: "row flex-between gap-8 flex-wrap" },
  ...
  async function render() {
    ...
    try {
      ...
      const editSection = el("div", { class: "card mt-8", style: "display:none;" });
      const addVersionSection = el("div", { class: "card mt-8", style: "display:none;" });
      ...
      if (editable) {
        ...
        const versionForm = el(
          ...
          el("label", { class: "row gap-8" }, activeInput, el("span", { text: "Active" })),
        ...
        sortedVersions.forEach((version, index) => {
          ...
          versionTableBody.appendChild(
            el("tr", {},
              ...
              el("td", {}, el("div", { class: "row gap-6 flex-wrap" }, diffLink, graphLink)),
            ),
          );
        });
      }
      ...
      content.innerHTML = "";
      content.append(
        el("div", { class: "row flex-between flex-wrap gap-8" },
          el("div", {},
          ...
          el("div", { class: "row gap-8 flex-wrap" }, editBtn, addVersionBtn, adminUser ? deleteBtn : null),
        ),
        ...
        el("div", { class: "card mt-12" },
          el("h3", { text: "Metadata" }),
          el("div", { class: "row gap-12 flex-wrap" },
        ...
        el("div", { class: "card mt-12" },
          ...
          ...sortedVersions.map((version) => {
            ...
            return el("div", { class: "mb-12" },
              el("div", { class: "font-semibold" }, `Version ${version.version}`),
              !rows.length
          ...
          !linkedVulns.length
            ...
            : el("div", { class: "flex-col-8" },
                ...linkedVulns.map((entry) =>
                  el("div", { class: "detail-border" },
                    el("div", { class: "font-semibold", text: entry.vuln.title || `Vulnerability ${entry.vuln.id}` }),
